...
from spirl.modules.subnetworks import BaseProcessingLSTM, Predictor, Encoder, EncoderPointNet
...
class PointNetSkillPriorMdl(SkillPriorMdl):
    ...
    def _build_prior_net(self):
        return nn.Sequential(
            ...
            EncoderPointNet(self._updated_encoder_params()),
            RemoveSpatial(),
