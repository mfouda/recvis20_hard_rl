...
class CustomLSTMCell(BaseCell):
    def __init__(self, nz_mid_lstm, n_lstm_layers, input_size, output_size, device, batch_size):
        """ An LSTMCell wrapper """
        super(CustomLSTMCell, self).__init__()
        
        hidden_size = nz_mid_lstm
...
class RecurrentPredictor(nn.Module):
    ...
    def __init__(self, nz_mid_lstm, n_lstm_layers, input_size, output_size, device, batch_size):
        super().__init__()
        # self._hp = hp
        self.cell = ForwardLSTMCell(nz_mid_lstm, n_lstm_layers, input_size, output_size, device, batch_size)
